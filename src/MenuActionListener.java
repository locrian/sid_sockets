...
public class MenuActionListener implements ActionListener, MouseListener{
    ...
    private int contador = 0;                                                   // a variavel contador vai ser responável pela distinção entre criar um novo socket cliente ou usar um criado previamente
    private SocketCliente socket_c;                                             // variavel que vai receber a referência da instanccia de SoketCliente
    private SocketServidor socket_s;                                            // variavel que vai receber a referência da instancia de SoketServidor
    private int same_machine = 1;                                               // variavel que define se o cliente e servidor estão na mesma máquina
    private String socket_c_erro= null;                                         // variavel que vai guardar o erro gerado pelo try dentro da classe SocketCLiente
    ...
    public void setSocketServidor(SocketServidor socket){                       // metodo que recebe a referência do SocketServidor
    ...
    public MenuActionListener(){                                                // Construtor sem parametros
 
    }
          
    public MenuActionListener(Menu menu) {
        this.menu = menu;                                                       // Construtor com um parametro. Recebe a referência do Menu principal
    ...
    ////// Uma vez que fizemos o implement do MouseEvent////////////////////////
    ///////////temos também de fazer override aos métodos abstratos/////////////
    @Override
